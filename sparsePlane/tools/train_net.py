...
class Trainer(DefaultTrainer):
    ...
    def build_test_loader(cls, cfg, dataset_name):
        return build_detection_test_loader(
            cfg,
            dataset_name,
            mapper=PlaneRCNNMapper(cfg, False, dataset_names=(dataset_name,)),
        )
...
def setup(args):
    ...
    setup_logger(
        output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="planercnn"
    )
    return cfg
